...
export const TalentFilterToolbar: React.FC<TalentFilterToolbarProps> = ({
  ...
  return (
    <div className="bg-surface dark:bg-primary-blue border border-border-theme dark:border-border-theme rounded-2xl p-5 shadow-sm space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5 pt-2 border-t border-border-theme dark:border-border-theme text-xs">
        <div>
      ...
      <div className="flex items-center justify-between text-xs text-text-muted dark:text-text-muted">
        <span>
          Showing <strong className="text-text-primary dark:text-white">{totalMatches}</strong> matching candidates
        </span>
