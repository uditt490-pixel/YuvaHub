...
import { Bell, Lock, UserX, Database, Info } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="clean-card p-6 dark:bg-gray-850 dark:border-gray-700">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100 dark:border-gray-700">
            <Info className="w-5 h-5 text-gray-400" />
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">About YuvaHub</h3>
          </div>
          <div className="flex justify-between items-center flex-wrap gap-3">
            <span className="text-xs text-gray-500 dark:text-gray-400">Learn about our mission, creators, stack and open-source values.</span>
            <button 
