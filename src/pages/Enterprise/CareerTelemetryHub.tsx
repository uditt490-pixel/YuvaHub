      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 text-[11px] font-bold uppercase tracking-widest flex items-center gap-1.5 border border-indigo-200 dark:border-indigo-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {students.map((student) => (
            <div
              ...
              className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md hover:border-blue-500 transition-all cursor-pointer space-y-4"
            >
              ...
              <div className="grid grid-cols-2 gap-2 text-center text-xs">
                ...
                <div className="p-2 rounded-xl bg-slate-50 dark:bg-slate-800/40">
                  <div className="text-[10px] text-slate-400 font-bold uppercase">Active Streak</div>
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-amber-50 dark:bg-amber-950 text-amber-600 dark:text-amber-400 font-bold text-xs flex items-center gap-1 hover:bg-amber-100 transition-colors"
                >
                  ...
                  <tr key={student.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[11px] text-slate-500">{student.institution}</div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="p-4 text-right space-x-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1 rounded-lg bg-amber-50 dark:bg-amber-950 text-amber-600 dark:text-amber-400 font-bold hover:bg-amber-100"
                      >
                        Intervene
                      </button>
                    </td>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 space-y-2 text-xs font-semibold">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-emerald-600">+22.4% over 30 days</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-center">
              <div className="p-3.5 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-900">
                <div className="text-xl font-black text-emerald-600 dark:text-emerald-400">91.4%</div>
                <div className="text-[10px] text-slate-500">Passing Rate</div>
              </div>
