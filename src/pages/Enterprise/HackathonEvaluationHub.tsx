      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="px-3 py-1 rounded-full bg-amber-50 dark:bg-amber-950 text-amber-600 dark:text-amber-400 text-[11px] font-bold uppercase tracking-widest flex items-center gap-1.5 border border-amber-200 dark:border-amber-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {submissions.map((project) => (
            <div
              ...
              className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md hover:border-amber-500 transition-all cursor-pointer space-y-4"
            >
              ...
              <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 space-y-1.5 text-xs">
                <div className="flex justify-between font-bold">
                  <span className="text-slate-500">Judge Rubric Score</span>
              ...
              <div className="flex flex-wrap gap-1">
                {project.techStack.slice(0, 3).map((tech) => (
                  <span key={tech} className="text-[10px] px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 font-medium">
                    {tech}
                  </span>
                ))}
              </div>
                  ...
                  <tr key={project.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        <span className="w-6 h-6 rounded-full bg-slate-100 dark:bg-slate-800 text-center font-bold flex items-center justify-center">
                          {idx + 1}
                        </span>
                        <div>
                          <div className="font-bold text-slate-900 dark:text-white">{project.title}</div>
                          <div className="text-[11px] text-slate-500">{project.teamName}</div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="p-4 font-extrabold text-amber-600 dark:text-amber-400 text-sm">
                      {project.compositeJudgeScore}%
                    </td>
                    ...
                    <td className="p-4 font-bold">
                      <span className={project.plagiarism.overallSimilarityIndex > 30 ? 'text-rose-600' : 'text-emerald-600'}>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 space-y-2 text-xs font-semibold">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-blue-600">Calibrated Transformer Classifier</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-center">
              <div className="p-3.5 rounded-2xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900">
                <div className="text-xl font-black text-amber-600 dark:text-amber-400">100%</div>
                <div className="text-[10px] text-slate-500">Audited Scoring</div>
              </div>
              <div className="p-3.5 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-900">
                <div className="text-xl font-black text-emerald-600 dark:text-emerald-400">Zero AI Bias</div>
                <div className="text-[10px] text-slate-500">Blind Double Scoring</div>
              </div>
            </div>
          </div>
        </div>
