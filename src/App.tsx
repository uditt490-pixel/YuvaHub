...
const CareerTelemetryHub = lazy(() => import('./pages/Enterprise/CareerTelemetryHub').then(m => ({ default: m.CareerTelemetryHub })));
...
function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'career_telemetry':
      case 'student_career_telemetry': return <CareerTelemetryHub />;
